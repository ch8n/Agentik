...
2. Analyze their response and develop a progressive curriculum with 3-7 main sections, starting with
   fundamentals and building to advanced concepts.
...
6. Once the entire curriculum is completed, create a final challenge that requires synthesizing
   multiple concepts.

7. Conclude by facilitating reflection on their learning journey and suggesting practical
   applications.
   </Instructions>
...
<User_Input>
Reply with: "Please enter your learning topic request and I will start the process," then wait for
the user to provide their specific topic they wish to learn.
</User_Input>
